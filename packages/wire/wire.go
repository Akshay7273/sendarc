...
// RFC 9382 Appendix B vectors and a shared set of deterministic SendBeam vectors under
// test-vectors/.
package wire
...
const ProtocolVersion = "sendbeam/1"
...
// rest are SendBeam's own key schedule layered on the RFC output.
const (
